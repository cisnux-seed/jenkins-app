pipeline {
    ...
    environment {
        ...
        TELEGRAM_BOT_TOKEN = '7992323994:AAGFPm-f74H_39DpfPmMN7cJ8y6VE-YloOY'
        TELEGRAM_CHAT_ID = '1309089514'
...
🔗 <b>Console:</b> ${env.BUILD_URL}console
        ...
        stage('📥 Source Code Checkout') {
            steps {
                ...
                git url: 'https://github.com/cisnux-seed/spring-jenk-app', branch: 'main'
